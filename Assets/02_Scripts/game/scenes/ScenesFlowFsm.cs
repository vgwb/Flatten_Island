...
public class ScenesFlowFsm : FiniteStateMachine
{
	...
	{
		//MonoGameApplication.instance.monoGameApplicationChef.Cook(MonoGameApplication.instance.monoGameApplicationChef.fadeOutMenuMusicRecipe);
	...
	private void UnloadingMainScene_OnEnter()
	{
		...
		InitScene.instance.loadingPanel.Enter(OnEnterMainSceneLoadingPanelCompleted);
	}

	private void OnEnterMainSceneLoadingPanelCompleted()
	{

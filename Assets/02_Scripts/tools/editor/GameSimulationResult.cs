...
public class GameSimulationResult
{
	...
	{
		writer.WriteLine("Simulation N., Win Result, Lose Result, Days, Day, Phase, Growth Rate, Capacity, Patients, Money, Public Opinion, Vaccine, Advisors, Chosen Advisor, Strategy, Chosen Suggestion, Chosen Option, Option Strategy, Active Stories, Start Story, Stop Story");
